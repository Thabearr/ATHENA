    ...
    def _observation(
        ...
        *,
        ...
        return HalfTimeObservation(
            ...
            full_time_home_goals=2,
            full_time_away_goals=1,
            half_time_home_goals=1 if valid else None,
            half_time_away_goals=0 if valid else None,
            source="verified_test_source",
            observed_at=self.OBSERVED_AT,
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            try:
                connection.executescript(
                    ...
                    INSERT INTO teams VALUES (1, 'Alpha FC');
                    INSERT INTO teams VALUES (2, 'Beta FC');
                    INSERT INTO historical_matches VALUES (
                        100, 1, 2, 2, 1, '2026-07-27T18:00:00+00:00',
            ...
            self.assertIsNone(observations[0].half_time_home_goals)
            self.assertIsNone(observations[0].half_time_away_goals)
