...
PR #117 campaign-specific historical adapter qualification. It freezes only the
next execution boundary and grants no downstream authority.
"""
...
PROTOCOL_SCOPE = "PRE_REGISTERED_FROZEN_CAMPAIGN_HISTORICAL_SOURCE_HISTORY_COMPLETENESS_AND_MATERIALIZATION_ONLY"
...
PR117_ORDINARY_FT_PROJECTION_SHA256 = "eddb7f5b58eb3cb92087dc7bf57a45a270aebabce38641cd3b4ffc2277d67ed3"
PR117_ORDINARY_FT_PROJECTION_SIZE = 22_080_831
PR80_CONSTRUCTION_SPEC_SHA256 = "75fe157d1b767cf374e5c2a27cc3d96434aa12f2214fc37d7c91b1e7127eb4b7"
...
COMPLETENESS_RULES = (
    ...
    "REQUIRE_THE_FROZEN_EUROPE_OSLO_DISPLAY_TIME_PROJECTION_AND_UTC_ORDERING_TO_AGREE_FOR_THE_MATERIALIZABLE_HISTORY_CORPUS_WITHOUT_CLAIMING_PR69_SOURCE_LOCAL_EQUIVALENCE",
...
MATERIALIZATION_RULES = (
    ...
    "SOURCE_LOCAL_KICKOFF_CANDIDATE_IS_DERIVED_FROM_CANONICAL_KICKOFF_UTC_USING_THE_FROZEN_EUROPE_OSLO_DISPLAY_BASIS_AND_MADE_NAIVE_WITH_PR69_SOURCE_LOCAL_SEMANTIC_EQUIVALENCE_STILL_UNPROVEN",
    ...
    "EVERY_MATERIALIZED_ROW_MUST_STRUCTURALLY_VALIDATE_AS_PR80_PROSPECTIVE_MATCH_EVIDENCE_WITHOUT_RELAXING_PR80_INVARIANTS_OR_CLAIMING_PR69_SOURCE_LOCAL_SEMANTIC_EQUIVALENCE",
...
NEXT_REQUIRED_BOUNDARY = "EXECUTE_REVIEWED_FOTMOB_HISTORICAL_SOURCE_HISTORY_COMPLETENESS_AND_MATERIALIZATION_QUALIFICATION"
...
PROTOCOL_SHA256 = "1917db656004305df9ce56dfdf049347733a591bde08d465c105bb7d98d1e6de"
PROTOCOL_SIZE = 9_962
...
def _payload() -> dict[str, Any]:
    return {
        ...
        "source_scope": {
            ...
            "pr80_source_local_semantic_equivalence": PR80_SOURCE_LOCAL_SEMANTIC_EQUIVALENCE,
...
__all__ = [
    ...
    "POSITIVE_EXECUTION_MUST_REMAIN_FALSE", "PR80_SOURCE_LOCAL_SEMANTIC_EQUIVALENCE",
    "PROTOCOL_ID", "PROTOCOL_SCOPE", "PROTOCOL_SHA256", "PROTOCOL_SIZE", "PROTOCOL_STATE",
    "QUALIFICATION_STATUS_VOCABULARY", "SOURCE_DISPLAY_TIME_BASIS", "SOURCE_NAMESPACE",
    "SPECIAL_STATE_OCCURRENCE_COUNTS", "FotMobHistoricalSourceHistoryCompletenessMaterializationProtocolError",
