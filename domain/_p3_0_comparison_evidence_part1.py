...
P3_CAPTURE_ARTIFACT_ENVELOPE_RELATIVE = "artifacts/p3-0-comparison-evidence"
P3_CAPTURE_IMMUTABLE_CHILD_RELATIVE = "artifacts/p3-0-comparison-evidence/capture"
P3_CAPTURE_PUBLICATION_POLICY_ID = "P3_E1_READINESS_ENVELOPE_IMMUTABLE_CAPTURE_CHILD_V1"
...
PAIRED_CAPTURE_PARTIAL = "PAIRED_CAPTURE_PARTIAL"
CAPTURE_ARTIFACT_PUBLICATION_FAILED = "CAPTURE_ARTIFACT_PUBLICATION_FAILED"

P3_CAPTURE_STAGE_FAILURE_TAXONOMY = frozenset({
