...
Result-free protocol only. It binds the exact successful V2 feature projection
to ATHENA's already-reviewed two-response deterministic Poisson-GLM family.
This module does not fit coefficients, build ScoreMatrix, calculate market
probabilities, inspect bookmaker prices, select bets, or authorize production.
"""
...
PROTOCOL_SHA256 = "0ae4966f4a048064f562f3a38218ff5731ce301b369918ed133bf150c1c6540a"
PROTOCOL_SIZE = 10903
...
_LINEAGE_FILES = {
    ...
    "domain/historical_expected_goals_successor_protocol.py":
        "f0b3a070bcf235a097dd737d715f9d6162505509",
    "domain/historical_expected_goals_successor_candidate.py":
        "d1d22f44436775a8fd7fa6d4970d8d230d59ebef",
    "domain/historical_expected_goals_successor_robustness_protocol.py":
        "b9efdb831363293826fc97b5145839232d7ac53d",
    ...
    "models/goals_model.joblib":
        "bdee71fd6c0b74f5343e8e01e010dd8032d6c694",
    "models/expected_goals.py":
...
_PROTOCOL_PAYLOAD_JSON = r'''{
  ...
  "candidate_arms": [
    ...
    {
      "away_lambda": "MEAN_TRAIN_AWAY_GOALS",
      "fit_population": "TRAIN_ONLY",
      "home_lambda": "MEAN_TRAIN_HOME_GOALS",
  ...
  "evaluation_contract": {
    ...
    "required_paired_deltas": [
      "NATIVE_REFIT_MINUS_ELO_ONLY",
      "NATIVE_REFIT_MINUS_HISTORICAL_FIXED_TRANSFER",
      "NATIVE_REFIT_MINUS_CONSTANT",
      "HISTORICAL_FIXED_TRANSFER_MINUS_CONSTANT",
      "NO_FATIGUE_MINUS_NATIVE_REFIT"
    ],
    "score_matrix_evaluation_in_this_boundary": false,
    "secondary_metrics": [
      "HOME_NLL","AWAY_NLL","HOME_BIAS","AWAY_BIAS","HOME_MAE","AWAY_MAE","HOME_RMSE","AWAY_RMSE","HOME_WACE","AWAY_WACE","HOME_WSCE","AWAY_WSCE"
    ],
    "strong_signal_rule": {
      "all_lineage_split_and_missingness_checks_pass": true,
      "native_away_wace_strictly_below_elo_away_wace": true,
      "native_away_wsce_strictly_below_elo_away_wsce": true,
      "native_home_and_away_fits_converge": true,
      "native_home_wace_strictly_below_elo_home_wace": true,
      "native_home_wsce_strictly_below_elo_home_wsce": true,
    ...
    "temporal_robustness": {
      ...
      "delete_one_cluster_estimates_required": true,
      "jackknife_standard_error_required": true,
      "normal_approximation_95_percent_interval_required": true,
      "paired_delta": "NATIVE_REFIT_MINUS_ELO_ONLY_MEAN_JOINT_NLL"
    }
  },
  "execution_receipt_requirements": {
    ...
    "must_report_all_quarter_delete_estimates_and_interval": true,
...
class FotMobUTCNativeExpectedGoalsModelValidationProtocolError(ValueError):
    """Raised when frozen protocol identity or local implementation lineage drifts."""
...
def _payload() -> dict[str, Any]:
    ...
    if value.get("historical_successor_prior", {}).get(
        "historical_home_coefficients"
    ) != list(HISTORICAL_HOME_COEFFICIENTS):
        raise _error("historical home coefficient transfer identity changed")
    if value.get("historical_successor_prior", {}).get(
        "historical_away_coefficients"
    ) != list(HISTORICAL_AWAY_COEFFICIENTS):
