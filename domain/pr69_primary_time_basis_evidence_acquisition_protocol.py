...
def _verify_upstream() -> None:
 if _git_blob_sha(Path(pr123.__file__))!=PR123_QUALIFICATION_BLOB_SHA: raise _error("PR123 qualification implementation blob changed")
