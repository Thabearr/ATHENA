...
_training_coverage_row_issuance = importlib.import_module(
    "._historical_training_coverage_row_issuance", __name__
)
_training_coverage_row_issuance.install(_historical_training_coverage)
