...
package initializes, then make the implementation module name resolve to the
same hardened module object.  Normal Python imports therefore cannot bypass the
canonical issuance boundary by importing the underscore implementation first.
"""
