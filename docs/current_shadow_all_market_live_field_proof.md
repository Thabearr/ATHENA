...
terminal short page only when its exact provider page item count is strictly
less than the requested page size. A full page still requires a later reviewed
